...
app.get('/support/article/17-navigating-the-platform', (req, res) => {
    res.render('17-navigating-the-platform');
});

app.get('/support/article/18-shapefile-help', (req, res) => {
    res.render('18-shapefile-help');
});

app.get('/support/article/19-view-rap-data-in-your-gis', (req, res) => {
    res.render('19-view-rap-data-in-your-gis');
});

app.get('/support/article/22-guiding-principles', (req, res) => {
    res.render('22-guiding-principles');
});

app.get('/support/article/23-the-map-layers-panel', (req, res) => {
    res.render('23-the-map-layers-panel');
});

app.get('/support/article/24-analyzing-your-region-of-interest', (req, res) => {
    res.render('24-analyzing-your-region-of-interest');
});

app.get('/support/article/25-the-interactive-map', (req, res) => {
    res.render('25-the-interactive-map');
});

app.get('/support/article/26-the-analysis-panel', (req, res) => {
    res.render('26-the-analysis-panel');
});

app.get('/support/article/45-using-rap-landing', (req, res) => {
    res.render('45-using-rap-landing');
});

app.get('/support/article/46-new-to-rap-start-here-landing', (req, res) => {
    res.render('46-new-to-rap-start-here-landing');
});

app.get('/support/article/47-what-is-rap-landing', (req, res) => {
    res.render('47-what-is-rap-landing');
});

app.get('/support/article/48-vegetation-cover-dataset', (req, res) => {
    res.render('48-vegetation-cover-dataset');
});

app.get('/support/article/49-rangeland-production', (req, res) => {
    res.render('49-rangeland-production');
});

app.get('/support/article/52-troubleshooting-and-faqs-landing', (req, res) => {
    res.render('52-troubleshooting-and-faqs-landing');
});

app.get('/support/article/53-analyze-rap-data-in-excel', (req, res) => {
    res.render('53-analyze-rap-data-in-excel');
});

app.get('/support/article/54-using-rap-in-rangeland-decision-making', (req, res) => {
    res.render('54-using-rap-in-rangeland-decision-making');
});

app.get('/support/article/55-multi-scale-rangeland-monitoring', (req, res) => {
    res.render('55-multi-scale-rangeland-monitoring');
});

app.get('/support/article/56-known-data-issues', (req, res) => {
    res.render('56-known-data-issues');
});

app.get('/support/article/57-agency-points-of-contact', (req, res) => {
    res.render('57-agency-points-of-contact');
});

app.get('/support/article/58-publications-and-reports', (req, res) => {
    res.render('58-publications-and-reports');
});

app.get('/support/article/59-rap-metadata', (req, res) => {
    res.render('59-rap-metadata');
});

app.get('/support/article/60-faqs', (req, res) => {
    res.render('60-faqs');
});

app.get('/support/article/61-processing-rap-data-in-google-earth-engine', (req, res) => {
    res.render('61-processing-rap-data-in-google-earth-engine');
});

app.get('/support/article/62-export-vegetation-cover-rasters', (req, res) => {
    res.render('62-export-vegetation-cover-rasters');
});

app.get('/support/article/63-export-annual-biomass-rasters', (req, res) => {
    res.render('63-export-annual-biomass-rasters');
});

app.get('/support/article/64-batch-export-vegetation-cover-csvs', (req, res) => {
    res.render('64-batch-export-vegetation-cover-csvs');
});

app.get('/support/article/65-batch-export-herbaceous-biomass-csvs', (req, res) => {
    res.render('65-batch-export-herbaceous-biomass-csvs');
});

app.get('/support/article/70-production-explorer', (req, res) => {
    res.render('70-production-explorer');
});
