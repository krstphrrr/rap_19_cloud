...
export class OverlayTypeSelectComponent implements OnInit {
  ...
  constructor(private router: Router, private routing: RoutingService, private mapState: MapStateService) {  }  onSelectOpened() {
  ...
  public setOverlayType(overlay_type: OverlayType, skipLayerOrderUpdate: boolean = false) {
